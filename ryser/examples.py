...
class Example2:
  ...
  def __init__(self):
    ...
    # The cells in 'bad_cells' fail both the symmetric and normal Hall's
    # condition.
    self.bad_cells = [[39, 47, 7, 15, 23, 31], \
                          [40, 48, 8, 16, 24, 32], \
    ...
    # The cells in 'symmetric_bad_cells' only fail the symmetric Hall condition.
    self.symmetric_bad_cells = [[39, 40, 47, 48, 5, 6, 7, 8, 13, 14, 15, 16, 21, 22, 23, 24], \
